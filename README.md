...
| `All 638 hand-written rows` | `unofficial.js` `COMBOS` |
...
All 638 hand-written rows cite a published combo. **533 are `verified` and 67 are `derived`** — the
...
rows. **1,377 candidates have been read.**

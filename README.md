...
| `All 779 hand-written rows` | `unofficial.js` `COMBOS` |
...
All 779 hand-written rows cite a published combo. **689 are `verified` and 90 are `derived`** — the
...
rows. **1,530 candidates have been read.**

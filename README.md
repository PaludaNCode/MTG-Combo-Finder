...
which is exactly where the method is least trustworthy. But **478 candidates have been
read, out of thousands proposed** — and which 478 is no longer a matter of reading the
